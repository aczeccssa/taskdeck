...
const detailedDescriptions:Record<string,string>={
  ...
  [`releases:v${version}`]:"The release page is the source of truth for the changelog and downloadable assets, while this documentation is built from the same version. Verify that the tag, Cargo version, archive names, and checksum file agree before publishing a link to users. Consumers should download both the asset and `SHA256SUMS` from the same tag rather than mixing latest and versioned URLs.",
