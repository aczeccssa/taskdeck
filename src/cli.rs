...
use crate::daemon::{self, configured_settings, is_running, open_daemon_log, request, root_path, socket_path};
...
pub(crate) fn print_service(status: anyhow::Result<crate::platform_service::ServiceStatus>) -> Result<()> {
